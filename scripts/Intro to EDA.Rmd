...
#### Exercise 1: We learned what a package is and how to install them

-   Learned what a "package is"
...
#### Exercise 4: We learned about `here()`
...
##### 7.1.1 Using the output from summary, identify and report the mean age of the participants in the
...
#### Example 9: Use `aes()` within the `ggplot()` command to declare `age` as the x axis variable from dataset df.
